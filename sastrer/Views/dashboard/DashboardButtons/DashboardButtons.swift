...
var measuresButtons = [
    ...
    MeasuresButtons(measuresTittle: "Suit jackect", measuresSubtitle: "Men's suits measures", footer: "All measurements needed for a suit*, a vest, a shirt, or a chacabana should be input here..",background: "bckgrnd", background1: "suit",background2: "suit2nobck",background3: "suit3nobck"),
    //vest measures button
    MeasuresButtons(measuresTittle: "Vests", measuresSubtitle: "Men's vests measures", footer: "All measurements needed for a vest should be input here..",background: "bckgrnd", background1: "vest3nobck",background2: "vest2nobck",background3: "vest1nobck"),
    //shirts measures button
    MeasuresButtons(measuresTittle: "Shirts", measuresSubtitle: "Men's suits measures", footer: "All measurements needed for a shirt, or a chacabana should be input here..", background: "bckgrnd",background1: "shirt2nobck",background2: "shirt1nobck",background3: "chashirtnobck"),
    //women jackets,blause,dress,skirt
    MeasuresButtons(measuresTittle: "Women Tops", measuresSubtitle: "Women's jackets measures", footer: "All measurements needed for a womens jackets,blause, dress and skirt should be input here..",background: "bckgrnd", background1: "dressnobck",background2: "blazer2nobck",background3: "skirtnobck",background4: "blausenobck"),
    //women vest
    MeasuresButtons(measuresTittle: "Vest", measuresSubtitle: "Women's vests measures", footer: "All measurements needed for a womens vests should be input here..",background: "bckgrnd", background1: "wvestnobck3",background2: "wvestnobck2",background3: "wvestnobck"),
    //pants
    MeasuresButtons(measuresTittle: "Pants", measuresSubtitle: "Pant's measures", footer: "All measurements needed for a pants should be input here..",background: "bckgrnd", background1: "pantsnobck",background2: "pantsnobck2",background3: "pantsnbck3",background4: "pantsnobck4")
